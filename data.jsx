...
const getRandomDate = () => {
    ...
    const randomTime = today.getTime() + Math.random() * (threeMonthsLater.getTime() - today.getTime());
...
const data = [
    {
      ...
      image: "https://images.squarespace-cdn.com/content/v1/55ee34aae4b0bf70212ada4c/1603189807717-FJWB1MX6RW1GNXZOS7YP/brandon-jean-w79UXGGlvhQ-unsplash.jpg",
